...
namespace qmapcontrol
{
    ...
    public:
		...
		LineString ( QList<Point*> const points, QString name = QString(), QPen* pen = 0 ,QColor c = QColor(255,255,0,150));
		LineString ( QList<Point*> const points, QString name = QString(), QPen* pen = 0 , QBrush b = QBrush(QColor(255,0,0,0),Qt::SolidPattern));
        ...
        virtual QList<Geometry*> clickedPoints();
		 ...
		 bool pointInsidePolygon(QPointF geom, const MapAdapter* mapadapter);
